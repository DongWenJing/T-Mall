  ...
  <div class="container1">
    ...
    <div class="desc-warp">
      <div class="desc-warp-item sign-up-desc">
        ...
        <img src="../../assets/upload/002.png" alt="" />
      </div>
      <div class="desc-warp-item sign-in-desc">
        <div class="content">
          <button id="sign-in-btn">登录</button>
        </div>
        <img style="width: 80%" src="../../assets/upload/001.png" alt="" />
      </div>
    </div>
  </div>
</template>
        ...
        request
          ...
          .then((res) => {
            if (res.code === '0') {
              ...
              sessionStorage.setItem('shopId', JSON.stringify(res.data.shopId))
